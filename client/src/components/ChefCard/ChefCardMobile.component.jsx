    ...
    <div style={{paddingBottom: '0px'}}>
      <Card className="text-light" style={{ border: 'none'}}>
        ...
        <Link to={`/chefs/${chef._id}/page/1`} style={{zIndex: '2'}}>
          <Card.Img src={chef.chefPicture} alt={chef.chefPicture} style={{height: '100px', width: '100%', backgroundColor: '#B2D732' }}/>
        </Link>
