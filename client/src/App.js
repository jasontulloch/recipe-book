    ...
    <Router>
      ...
      <main className="py-3">
        <Container className=''>
          ...
          <Route path='/recipes/advanced-search-results/keywordRecipeName=:keywordRecipeName/keywordCookTimeMin=:keywordCookTimeMin/keywordCookTimeMax=:keywordCookTimeMax/keywordIsVegan=:keywordIsVegan/keywordIsVegetarian=:keywordIsVegetarian/keywordIsGlutenFree=:keywordIsGlutenFree/keywordIsKetogenic=:keywordIsKetogenic' component={AdvancedRecipeSearchResultsPage} exact/>
          <Route path='/recipes/advanced-search-results/keywordCountry=:keywordCountry/keywordCookTimeMin=:keywordCookTimeMin/keywordCookTimeMax=:keywordCookTimeMax/keywordIsVegan=:keywordIsVegan/keywordIsVegetarian=:keywordIsVegetarian/keywordIsGlutenFree=:keywordIsGlutenFree/keywordIsKetogenic=:keywordIsKetogenic' component={AdvancedRecipeSearchResultsPage} exact/>
          <Route path='/recipes/advanced-search-results/keywordChefName=:keywordChefName/keywordCookTimeMin=:keywordCookTimeMin/keywordCookTimeMax=:keywordCookTimeMax/keywordIsVegan=:keywordIsVegan/keywordIsVegetarian=:keywordIsVegetarian/keywordIsGlutenFree=:keywordIsGlutenFree/keywordIsKetogenic=:keywordIsKetogenic' component={AdvancedRecipeSearchResultsPage} exact/>
          <Route path='/recipes/advanced-search-results/keywordRecipeName=:keywordRecipeName/keywordCountry=:keywordCountry/keywordCookTimeMin=:keywordCookTimeMin/keywordCookTimeMax=:keywordCookTimeMax/keywordIsVegan=:keywordIsVegan/keywordIsVegetarian=:keywordIsVegetarian/keywordIsGlutenFree=:keywordIsGlutenFree/keywordIsKetogenic=:keywordIsKetogenic' component={AdvancedRecipeSearchResultsPage} exact/>
          <Route path='/recipes/advanced-search-results/keywordRecipeName=:keywordRecipeName/keywordChefName=:keywordChefName/keywordCookTimeMin=:keywordCookTimeMin/keywordCookTimeMax=:keywordCookTimeMax/keywordIsVegan=:keywordIsVegan/keywordIsVegetarian=:keywordIsVegetarian/keywordIsGlutenFree=:keywordIsGlutenFree/keywordIsKetogenic=:keywordIsKetogenic' component={AdvancedRecipeSearchResultsPage} exact/>
